...
<?php } ?>
    ...
    <?php } ?>
      ...
      <h5 class="headline headline--small-plus text-purple">Fill out the form below and we’ll get to work right away!</h5>
  ...
  <div class="container page-section grey-bg">
    <h2 class="headline headline--small-plus t-center text-purple underline">Submit your brief</h2>
    <div class="full-width-split group">
      <div class="full-width-split__one">
        <div class="full-width-split__inner">
            <div class="contact-form">
          <?php echo do_shortcode( '[contact-form-7 id="73" title="submit-brief"]' ); ?>
        </div>
        </div>
      </div>
        ...
        <div class="full-width-split__two">
          <div class="full-width-split__inner">
            <div class="workbox">
          <img src="<?php echo get_theme_file_uri('/images/client-shake.jpg'); ?>" class="col-image" alt="A man in a suit extending his hand for a handshake">
        </div>
          </div>
        </div> 
    </div>
